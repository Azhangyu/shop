            ...
            <form action="" method="post">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="password"  class="txt" name="password_as" />
                        <p> <span>请再次输入密码</p>
                    </li>
                    <li>
                        <label for="">邮箱：</label>
    ...
    function bindPhoneNum(){
        ...
        var interval = setInterval(function(){
            ...
            $('#get_captcha').val(html);
                ...
                var tel = $('#tel').val();
//        getJSON 发起ajax请求           路径            传递的参数 json格式       执行的方法 回调函数
        $.getJSON("<?= \yii\helpers\Url::to(['user/sms'])?>",{tel:tel},function (data){
//            if(data==true){
                console.log(data);
//            }
        });
...
//    });
    ...
    $("form").validate({
        rules: {
            username: {
                required:true,
                remote:'/user/validate-username'//ajax后台验证remote
            },
            password: {
                required:true,
                minlength: 5
            ...
            captcha:{
                required: true,
                remote:'/user/validatetel'//ajax后台验证remote
            }
        },
        errorElement:'span'
    });
