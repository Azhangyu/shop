...
<!--            --><?php //foreach ($models as $model):?>
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?= $models->logo?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?= $models->logo?>" alt="" width="350" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
<!--	--><?php //endforeach;?>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="market_price"><span>定价：</span><em><?= $models->stock?></em></li>
					...
					<form action="<?=\yii\helpers\Url::to(['goods/notice'])?>" method="get" class="choose">
						<ul>
